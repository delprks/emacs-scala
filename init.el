...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ag dumb-jump ido-grid-mode yafolding slime markdown-mode rainbow-delimiters monokai-theme neotree expand-region window-numbering ace-jump-mode find-file-in-repository multiple-cursors magit ensime helm key-chord color-theme-monokai))))
(custom-set-faces
